/// @description  @function                       scale_canvas(base width, base height, current width, current height, center);
/// @param base width
/// @param  base height
/// @param  current width
...
function scale_canvas(argument0, argument1, argument2, argument3, argument4) {
	...
	__view_set( e__VW.WPort, 0, min(window_get_width(), _bw) );
	__view_set( e__VW.HPort, 0, min(window_get_height(), _bh) )
